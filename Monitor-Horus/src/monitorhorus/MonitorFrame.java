...
public class MonitorFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnNumeroSerie = new javax.swing.JButton();
        ...
        textFieldNumeroSerie.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                textFieldNumeroSerieKeyTyped(evt);
            }
        });

        btnNumeroSerie.setText("Numero Serie");
        btnNumeroSerie.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNumeroSerieActionPerformed(evt);
            }
        });
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(textFieldNumeroSerie))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnNumeroSerie, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnNumeroSerie)
                    .addComponent(textFieldNumeroSerie, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder("Enviar Stream"));

        textFieldStream.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textFieldStreamActionPerformed(evt);
            }
        });
    ...
    private void textFieldStreamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textFieldStreamActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textFieldStreamActionPerformed

    
    private void btnNumeroSerieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNumeroSerieActionPerformed

        String numSerie = textFieldNumeroSerie.getText().trim();

        
        
       /*
        
        Requesito do número de serie 
        Num   19      02      16      04      20
        
        Hex   3139    3032    3136    3034    3230
        
        Short 12601   12.338  12.598  12.340  12.848
        
        Stream de gravacao montada 
        01 10 01 F4 00 05 0A 39 31 32 30 36 31 34 30 30 32 ED FB 
        01 10 01 F4 00 05 0A 39 31 32 30 36 31 34 30 30 32 ED FB
*/
        
       
        if (numSerie.length() == 10 && !numSerie.equals("")) {

            if (conexaoTCP) {

                char[] charOutPut = numSerie.toCharArray();

                short[] ShortArray = new short[numSerie.length() / 2];

                int count = 0;

                
                //Arrar que recebe os valores em short 
                for (int i = 0; i < ShortArray.length; i++) {

                    String hex = "" + charOutPut[count] + charOutPut[count + 1];

                    System.out.println("str" + hex);
                    System.out.println("hexconvertido" + toHex(hex));
                    ShortArray[i] = Short.parseShort(toHex(hex), 16);
                    System.out.println("]]" + ShortArray[i]);
                    count += +2;
                }

                byte[] outputArray = new byte[numSerie.length() + 9];

                short ederecoModbus = 500;
                

                outputArray[0] = (byte) 1;
                outputArray[1] = (byte) 16;
                outputArray[2] = (byte) ((ederecoModbus >> 8) & 0xff); //endereo inicial
                outputArray[3] = (byte) (ederecoModbus & 0xff);
                outputArray[4] = (byte) ((numSerie.length() / 2 >> 8) & 0xff);  //numero de registro
                outputArray[5] = (byte) (numSerie.length() / 2 & 0xff);
                outputArray[6] = (byte) (numSerie.length() / 2 * 2); //tamanho em bytes dos registros 

                // inicie de insersao dos dados no arrary 
                int insertMsg = 7;

                //carrega no buffer de saida o dados do número de serie 
                for (int i = 0; i < ShortArray.length; i++) {
                    
                    outputArray[insertMsg] = (byte) (ShortArray[i] & 0xff);//lsb
                    outputArray[insertMsg + 1] = (byte) ((ShortArray[i] >> 8) & 0xff);//msb
                    insertMsg += +2;
                }

                try {
                    
                    //carrega no buffer de saida os dados com o calculo de CRC 
                    byte[] resp = socketClient.enviarComando(byteArrayToHexString(respostaCalCRC(outputArray)), carregaTimeout());
                    ...
                    if (resp.length > 0) {
                     ...
                     //Resposta travada para gravacao com 10 digitos 
                        if (respHexa.equals("011001f400054004")) {
                            escreveTextArea("Comando para troca do número de serie executado com sucesso!");
                        }
            ...
            JOptionPane.showMessageDialog(null, "Para realizar a gravação do número de serie, insira 10 digitos ");
        }
    }//GEN-LAST:event_btnNumeroSerieActionPerformed

    private void textFieldNumeroSerieKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textFieldNumeroSerieKeyTyped
    ...
    }//GEN-LAST:event_textFieldNumeroSerieKeyTyped
...
public String toHex(String arg) {
    ...
    private javax.swing.JButton btnNumeroSerie;
